...
class ToolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post tools_url, params: { tool: { image: @tool.image, make: @tool.make, model: @tool.model, name: @tool.name, serial: @tool.serial } }
    end
  ...
  test "should update tool" do
    patch tool_url(@tool), params: { tool: { image: @tool.image, make: @tool.make, model: @tool.model, name: @tool.name, serial: @tool.serial } }
